...
- Description: Check if user input and output in **_limitOrder_** is not out of limit rate
- Params:
...
- Description: Get top pool with giving the value such as: liquidity, apr, volume .
- Request Params:
  - limit (number): limit number of pool to select,
  - selectValue ("liquidity" | "apr30d" | "apr7d" | "apr24h" | "volume24h" | "volume7d" | "volume30d"): type of field to sort,
  - deepDetail (bool): deep tracking pool detail (updating...), pass "false" by default
- Ex: get top 5 pool with the highet volume in 24h
  ```
    http://localhost:3000/api/v1/raydium/aprPools?limit=5&selectValue=liquidity&deepDetail=false
  ```
- Sample response:
  ...
  [
  {
    "poolId": "AS5MV3ear4NZPMWXbCsEz3AdbCaXEnq4ChdaWsvLgkcM",
    "price": 1.000026307910206,
    "tvl": 70035004.4,
    "mintAmountA": 33463996.214237,
    "mintAmountB": 36570127.455837,
    "mintA": {
      "chainId": 101,
    ...
    "day": {
      "volume": 2171244.717936952,
      "volumeQuote": 2171407.427684835,
      "volumeFee": 217.12447179369525,
      "apr": 0.48227261824271916,
      "feeApr": 0.11,
      "priceMin": 0.999805742258829,
      "priceMax": 1.000127294699109,
      "rewardApr": [
        0,
        0.3722726182427192
      ]
    ...
    "week": {
      "volume": 18710242.3726513,
      "volumeQuote": 18711237.245527085,
      "volumeFee": 1871.0242372651303,
      "apr": 0.4522726182427192,
      "feeApr": 0.08,
      "priceMin": 0.9997536475112512,
      "priceMax": 1.0002616889760243,
      "rewardApr": [
        0,
        0.3722726182427192
      ]
    ...
    "month": {
      "volume": 394873477.23139584,
      "volumeQuote": 394897563.73087406,
      "volumeFee": 39487.34772313958,
      "apr": 1.0522726182427191,
      "feeApr": 0.68,
      "priceMin": 0.9985355053634551,
      "priceMax": 1.0007572889057177,
      "rewardApr": [
        0,
        0.3722726182427192
      ]
    },
    "raydiumStake": "https://raydium.io/clmm/create-position/?pool_id=AS5MV3ear4NZPMWXbCsEz3AdbCaXEnq4ChdaWsvLgkcM"
  },...
  ]
